...
import com.map.controller.testService.Map_Service;
...
public ResponseEntity<?> testApiLoad(@RequestParam Map<String, String> map)throws Exception {
	...
	try {
      ...
      FileInputStream f=new FileInputStream("‪C:\\Users\\deepi\\Downloads\\direction\\direction\\src\\main\\resources\\best.properties");
...
FileOutputStream out = new FileOutputStream("D:\\FileOperations\\deepiDetails.properties");
prop.store(out,"Details of deepi");
